@echo off
REM AradVision 一键安装脚本
REM 用法: 双击运行或在 PowerShell 中执行 ./install.bat
...
REM 安装基础依赖（CPU 版本，更快）
pip install numpy PyYAML loguru pytest pytest-cov
...
REM 安装 Windows 输入控制
pip install pydirectinput pywin32
